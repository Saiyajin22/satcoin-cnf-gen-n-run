...
__CPROVER_assume(*u_nonce > 547368371 && *u_nonce < 547369371);
#endif
...
unsigned int block_780499[20] = {0x0000912a,
0xcafe7d4f,
0x0e32b719,
0xc6c8fcf2,
0xd548056f,
...
0x81760617,
0x20a02fa7};
int main(int argc, void *argv[]){verifyhash(&block_780499[0]); return 0;}